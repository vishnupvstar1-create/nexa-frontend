...
function ContactUs() {
  ...
  // ADD THIS BLOCK: Scroll to top when the Contact page loads
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    // FIX: Added 'pb-24' right here to push the footer down!
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none transition-all"
